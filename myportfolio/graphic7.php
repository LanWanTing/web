...
<title>新城市印象海報_平面設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pGraphic">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">新城市印象海報</div>
        <div class="pNameEn lPd">New City Impression</div>
        <div class="pInfo lPd">
        大多數人對城市的印象就是擁擠、喧鬧、繁華，人比車多且步調快速。<br>
        在將來的都市的建設中，期待見到的是城市的慢活與清閒悠哉的感覺，減少繁鬧的緊張氛圍，給與都市人喘息的空間。
        </div>
        <div class="pElseInfo lPd">2011/04/19<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/graphic/gra_ncity_b.jpg" alt="新城市印象海報"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/graphic/gra_ncity_s.jpg" alt="新城市印象海報"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
