...
<title>2013新年賀卡_平面設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pGraphic">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">2013新年賀卡</div>
        <div class="pNameEn lPd">2013New Year Greeting Card</div>
        <!--<div class="pInfo lPd">
        新年賀卡以當年度的代表生肖與文字結合作為主體。<br>
        2013年的賀卡以吉祥的花卉與剪花為輔結合而成。
        </div>-->
        <div class="pElseInfo lPd">2013/01/27<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/graphic/gra_2013nyc_b.jpg" alt="2013新年賀卡"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/graphic/gra_2013nyc_s.jpg" alt="2013新年賀卡"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
