...
<title>2011兔年月曆_平面設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pGraphic">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">2011兔年月曆</div>
        <div class="pNameEn lPd">2011 Calendar</div>
        <div class="pInfo lPd">
        2011年在中國屬於兔年，所以以「兔子」為主軸設計月曆，以一隻「兔子」插圖貫穿整本月曆，她活潑跳躍在每個月參與不同的活動，每頁右邊的插圖範圍可以撕下當作書籤使用。
        </div>
        <div class="pElseInfo lPd">2010/06/21<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/graphic/gra_2011_b1.jpg" alt="2011兔年月曆"></li>
                <li><img src="images/graphic/gra_2011_b2.jpg" alt="2011兔年月曆"></li>
                <li><img src="images/graphic/gra_2011_b3.jpg" alt="2011兔年月曆"></li>
                <li><img src="images/graphic/gra_2011_b4.jpg" alt="2011兔年月曆"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/graphic/gra_2011_s1.jpg" alt="2011兔年月曆"></li>
                  <li><img src="images/graphic/gra_2011_s2.jpg" alt="2011兔年月曆"></li>
                  <li><img src="images/graphic/gra_2011_s3.jpg" alt="2011兔年月曆"></li>
                  <li><img src="images/graphic/gra_2011_s4.jpg" alt="2011兔年月曆"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
