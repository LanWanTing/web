...
<title>形象設計_PEONY DRESS CIS設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pImage">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">PEONY DRESS CIS設計</div>
        <div class="pNameEn lPd">PEONY DRESS CO.LTD</div>
        <div class="pInfo lPd">
         「PEONY DRESS」是一間融和中西風格的服裝設計公司。<br>
         以牡丹造型設計LOGO，並排成西式風格的蕾絲，帶出中西榮合之感。<br>
         顏色採用明度高且彩度高的粉紅色，表現出女性亮麗、大方的PEONY DRES服裝形象。<br>
        </div>
        <div class="pElseInfo lPd">2014/01/29<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/image/img_peony_b1.jpg" alt="主標誌"></li>
                <li><img src="images/image/img_peony_b2.jpg" alt="CIS"></li>
                <li><img src="images/image/img_peony_b3.jpg" alt="CIS"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/image/img_peony_s1.jpg" alt="主標誌"></li>
                  <li><img src="images/image/img_peony_s2.jpg" alt="CIS"></li>
                  <li><img src="images/image/img_peony_s3.jpg" alt="CIS"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
