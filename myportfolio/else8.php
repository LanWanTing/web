...
<title>銀飾攝影_其他作品│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pElse">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">銀飾攝影</div>
        <div class="pNameEn lPd">Silver</div>
        <div class="pElseInfo lPd">2011/10/17</div>
    </div>
    <!--相簿開始-->
    <div class="viewRight">	
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/else/else_silver_b1.jpg" alt="銀飾攝影"></li>
                <li><img src="images/else/else_silver_b2.jpg" alt="銀飾攝影"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                 <li><img src="images/else/else_silver_s1.jpg" alt="銀飾攝影"></li>
                 <li><img src="images/else/else_silver_s2.jpg" alt="銀飾攝影"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
