...
<title>形象設計_靜觀奇變 文字設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pImage">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">靜觀奇變 文字設計</div>
        <div class="pNameEn lPd">Wait and See</div>
        <div class="pInfo lPd">
       「靜觀其變」意指靜靜的觀察人事物的變化。<br>
       此成語文字設計是給校慶闖關遊戲活動所取的名字，根據闖關遊戲活動內容將靜觀其變改為「靜觀奇變」。<br>
       以靜、奇、變三字的字面意思將文字以沉穩的外貌增添變化，以文字簡化、連結等方式為基礎，並增加渦旋等有像、抽像圖像元素來設計文字。
       </div>
        <div class="pElseInfo lPd">2011/10/08<br>2011校慶闖關遊戲活動<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/image/img_was_b.jpg" alt="主標誌"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/image/img_was_s.jpg" alt="主標誌"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
