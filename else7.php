...
<title>花卉商品攝影_其他作品│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pElse">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">花卉商品攝影</div>
        <div class="pNameEn lPd">Flower</div>
        <div class="pElseInfo lPd">2010/10/15</div>
    </div>
    <!--相簿開始-->
    <div class="viewRight">	
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/else/else_flower_b1.jpg" alt="花卉商品攝影"></li>
                <li><img src="images/else/else_flower_b2.jpg" alt="花卉商品攝影"></li>
                <li><img src="images/else/else_flower_b3.jpg" alt="花卉商品攝影"></li>
                <li><img src="images/else/else_flower_b4.jpg" alt="花卉商品攝影"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                 <li><img src="images/else/else_flower_s1.jpg" alt="花卉商品攝影"></li>
                 <li><img src="images/else/else_flower_s2.jpg" alt="花卉商品攝影"></li>
                 <li><img src="images/else/else_flower_s3.jpg" alt="花卉商品攝影"></li>
                 <li><img src="images/else/else_flower_s4.jpg" alt="花卉商品攝影"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
