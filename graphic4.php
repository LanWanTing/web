...
<title>2014新年賀卡_平面設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pGraphic">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">2014新年賀卡</div>
        <div class="pNameEn lPd">2014New Year Greeting Card</div>
        <!--<div class="pInfo lPd">
        新年賀卡以當年度的代表生肖與文字結合作為主體。<br>
        2014年的賀卡以摻有金箔的大紅色與剪花為結合而成。
        </div>-->
        <div class="pElseInfo lPd">2014/01/20<br>
        <img class="viewPic"src="images/PsCS3.jpg" alt="IllCS3" width="20" height="20" />&nbsp;&nbsp;電腦繪圖</div>
    </div>
    <!--相簿開始-->
    <div class="viewRight">	
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/graphic/gra_2014nyc_b.jpg" alt="2014新年賀卡"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/graphic/gra_2014nyc_s.jpg" alt="2014新年賀卡"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
