...
<title>形象設計_Bumper團購商店 CIS設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pImage">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">Bumper團購商店 CIS設計</div>
        <div class="pNameEn lPd">Bumper Group Shopping Store</div>
        <div class="pInfo lPd">
        「Bumper」是一間在商家與消費者之間建立溝通橋梁的諮詢公司。<br>
        標誌以緞帶繞出流線的英文造型，採簡潔與共用筆畫帶出現代化的視覺樣貌。<br>
        設計上採用圓滑的組合型式，傳達Bumper跟消費者之間的密合與信賴，配色採用明度高且繽紛的色彩，表現出歡樂、親和的企業形象。<br>好」的企業形象。
        </div>
        <div class="pElseInfo lPd">2011/06/30<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/image/img_bumper_b1.jpg" alt="主標誌"></li>
                <li><img src="images/image/img_bumper_b2.jpg" alt="CIS"></li>
                <li><img src="images/image/img_bumper_b3.jpg" alt="CIS"></li>
                <li><img src="images/image/img_bumper_b4.jpg" alt="CIS"></li>
                <li><img src="images/image/img_bumper_b5.jpg" alt="CIS"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/image/img_bumper_s1.jpg" alt="主標誌"></li>
                  <li><img src="images/image/img_bumper_s2.jpg" alt="CIS"></li>
                  <li><img src="images/image/img_bumper_s3.jpg" alt="CIS"></li>
                  <li><img src="images/image/img_bumper_s4.jpg" alt="CIS"></li>
                  <li><img src="images/image/img_bumper_s5.jpg" alt="CIS"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
