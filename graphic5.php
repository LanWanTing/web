...
<title>巧克力幸福‧甜蜜的交匯-貴賓之夜邀請卡_平面設計│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pGraphic">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">巧克力幸福‧甜蜜的交匯<BR>貴賓之夜邀請卡</div>
        <div class="pNameEn lPd">Happy sweet chocolate invitation card</div>
        <!--<div class="pInfo lPd">
        設計巧克力幸福‧甜蜜的交匯展覽活動，專屬VIP貴賓之晚宴邀請卡。
        </div>-->
        <div class="pElseInfo lPd">2013/01/13<br>
        <img class="viewPic"src="images/pscs6.jpg" alt="PSCS6" width="20" height="20" />&nbsp;&nbsp;電腦繪圖</div>
    </div>
    <!--相簿開始-->
    <div class="viewRight">	
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/graphic/gra_inc_b.jpg" alt="邀請卡"></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/graphic/gra_inc_s.jpg" alt="邀請卡"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
