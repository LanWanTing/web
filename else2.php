...
<title>求生e智-手機篇_其他作品│TINA LAN PORTFOLIO</title>
...
<div id="pMain">
 <div id="pElse">
    <div class="pLeft">
        ...
        <div class="pNameCh lPd">求生e智-手機篇短片</div>
        <div class="pNameEn lPd">EIS-Cell Phone</div>
        <div class="pInfo lPd">
        畢業作品「求生e智」是一個互動防災資訊平台，最大的重點在於智慧型手機APP系統的開發，以融入生活的方式帶出手機系統的介紹。<br><br>
        <span id="else"><a href="http://youtu.be/1h2lIGVLX4k" title="求生e智-手機篇 介紹短片" target="_blank">點此前往 觀賞影片</a></span>
        </div>
        <div class="pElseInfo lPd">2012/02/13<br>參加育秀盃 複賽介紹短片<br>藍宛亭、陳巧玲、王麗惠共同參與製作<br>
          ...
          <div id="bannerWrap">
            ...
            <div class="main-slider-content">
              <ul class="sliders-wrap-inner">
                <li><img src="images/else/else_cell_b.jpg" alt="求生e智-手機篇"></a></li>
              </ul>  	
            </div>
            <!-- Small -->
            <div class="navigator-content">
              <div class="navigator-wrapper">
                <ul class="navigator-wrap-inner">
                  <li><img src="images/else/else_cell_s.jpg" alt="求生e智-手機篇"></li>
                </ul>
              </div>
            </div>
            <!-- Small end -->
